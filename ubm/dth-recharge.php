...
<title>Union Bank Money - Sms Syntax - DTH Recharge</title>
...
<a href="index.php"><img src="images/home_icon2.jpg" width="14" height="14" /></a> <a href="money-transfer.php">Support</a> &nbsp;DTH Recharge
</div>
<div class="clear"></div>
...
<li class="active"><a href="dth-recharge.php">DTH Recharge</a></li>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
 ...
 <?php
  ...
  ?>
  <tr>
    <td><?php echo stripslashes(html_entity_decode( $resultRecharge['operator'],ENT_QUOTES)); ?></td>
    <td><?php echo stripslashes(html_entity_decode( $resultRecharge['code'],ENT_QUOTES)); ?></td>
    <td><?php echo stripslashes(html_entity_decode( $resultRecharge['account_id'],ENT_QUOTES)); ?></td>	
